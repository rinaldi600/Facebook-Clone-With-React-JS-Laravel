    ...
    return (
        <Fragment>
            <div className={"flex min-h-[56px] flex-wrap font-Helvetica bg-red-400 shadow-md"}>
                ...
                <div className={"relative w-[50%] gap-2 items-center justify-center flex md:w-[25%] bg-green-400"}>
                    ...
                    <div style={{boxShadow: 'rgba(99, 99, 99, 0.2) 0px 2px 8px 0px'}} className={"w-full inset-x-0 bottom-[-150px] bg-white p-2 min-h-[100px] rounded-lg absolute"}>
                        <div style={{boxShadow: 'rgba(0, 0, 0, 0.35) 0px 5px 15px'}} className={"w-11/12 mb-5 min-h-[110.662px] bg-white rounded-lg p-4"}>
                            <div style={{borderBottom : '2px solid #CED0D4'}} className={"flex items-center gap-2 pb-4"}>
                                <div className={"w-[40px] h-[40px] rounded-full cursor-pointer overflow-hidden"}>
                                    <img className={"w-full h-full"} src={user.photo_profile} alt=""/>
                                </div>
                                <p className={"text-base text-[#050505] font-semibold"}>{user.name}</p>
                            </div>
