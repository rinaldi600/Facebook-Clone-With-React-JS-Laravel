...
function PeopleOnline(props) {
    return (
        <div className={"flex items-center gap-4 hover:bg-[#E4E6E9] relative pb-1 pl-1 rounded-lg pt-1"}>
            <div style={{border: '2px solid #1876F2'}} className={"w-[36px] h-[36px] rounded-full overflow-hidden"}>
